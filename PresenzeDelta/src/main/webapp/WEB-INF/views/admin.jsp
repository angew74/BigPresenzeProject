...
<html>
    <head>
        ...
        <link href="<c:url value="/resources/css/users/panel.css" />" type="text/css" rel="stylesheet" />     
    </head>   
    <body>    
                ...
                <div class="row">
                    <ul class="process-wrapp">
                        ...
                        <li class="wow fadeIn" data-wow-delay="400ms">
                            ...
                            <p class="bottom0">visualizzare il riepilogo delle attività degli utenti e delle ore di lavoro dei collaboratori</p>
                        </li>
                        <li class="wow fadeIn" data-wow-delay="450ms">
                            ...
                            <h4 class="font-light darkcolor bottom25">Qualità</h4>
                            <p class="bottom0">caricare e scaricare documenti sulla qualità</p>
                        </li>
