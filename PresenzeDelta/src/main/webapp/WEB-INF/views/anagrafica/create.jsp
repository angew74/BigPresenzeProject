                            ...
                            <div id="dynamic_container">
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                           ...
                                           id="username"
                                           placeholder="Username" required name="username" class="form-control"/>
                                </div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                           ...
                                           placeholder="User id" disabled required id="iduser" name="iduser" class="form-control"/>
                                </div>
                                <div class="form-group row">
                                    <span class="col-md-1 col-md-offset-2 text-center"></span>
                                    <div class="col-md-8">   
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                           ...
                                           placeholder="Nome" required name="nome" class="form-control"/>
                                </div>
                                <div class="form-group row">
                                    <span class="col-md-1 col-md-offset-2 text-center"></span>
                                    <div class="col-md-8">   
                                ...
                                <div class="input-group mt-3">
                                    ...
                                    <input type="text"
                                           ...
                                           placeholder="Cognome" required name="cognome" class="form-control"/>
                                </div>
                                <div class="form-group row">
                                    <span class="col-md-1 col-md-offset-2 text-center"></span>
                                    <div class="col-md-8">   
